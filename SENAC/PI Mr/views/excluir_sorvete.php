...
<body>
    ...
    <div class="container-xl" style="margin: 50px auto;">
        <div class="pag_admin">
            <h1> Excluir Sorvete </h1>
            <h5> Exclua qualquer sorvete do site </h5>
            ...
            <div>
                <div class="pag_buscar_sor">
                    ...
                    <!-- <div class="form-group">
                            <label for="nome_excluir"> Buscar pelo Nome do Sorvete </label>
                            <input type="text" name="nome_excluir" class="form-control" id="nome_excluir">
                ...
                <div class="pag_buscar_sor">
                    <form method="post">
                        <div class="form-group">
                            <label for="id_busca"> Digite o ID do Sorvete que deseja excluir </label>
                            <input type="number" name="id_busca" class="form-control" value="<?php //echo @$id_busca;?>" min="0" max="50" id="id_buscar" 
                            placeholder="">
                            <?php
            require_once "../objetos/obj_excluir.php";
            ?>
                            <!-- Excluir-->
