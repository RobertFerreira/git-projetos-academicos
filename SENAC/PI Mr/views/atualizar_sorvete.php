...
<body>
    ...
    <div class="container-xl" style="margin: 50px auto;">
        <div class="pag_admin">
            <h1> Atualizar Sorvete </h1>
            <h5> Atualize qualquer sorvete do site </h5>
                 ...
                 <!-- <div class="pag_buscar_sor"> -->
                    <!-- <form method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" name="nome_busca" class="form-control" id="nome_busca">
                ...
                <div class="pag_buscar_sor">
                    <form method="post">
                        <div class="form-group">
                            ...
                            <input type="number" name="id_busca" class="form-control" 
                            value="<?php// echo $id_busca;?>" min="0" max="50" id="id_busca"
                            placeholder="<?php require_once "../objetos/obj_buscaMod.php"; ?>">
                            <button type="submit" class="btn btn-primary"> Buscar </button>
            ...
            <div class="pag_buscar_read_form">
                <form method="post" enctype="multipart/form-data">
                    <div class="form-group pag_atualizar button">
                        ...
                        value="<?php echo @$nome;?>" id="nome">
                        <label for="marca"> Marca </label>
                        <input type="text" name="marca" class="form-control"
                        value="<?php echo @$marca;?>" id="marca">
                        <label for="nota"> Nota </label>
                        <input type="text" name="nota" class="form-control"
                        value="<?php echo @$nota;?>" id="nota">
                    </div>
                <!-- </form> -->
            </div>
            <div class="pag_buscar_read_form">
                <!-- <form> -->
                    <div class="form-group">
                        ...
                        <textarea name="descricao" class="form-control" rows="3" id="descricao"><?php echo @$descricao;?>
                        </textarea>
                        <label for="ingredientes"> Ingredientes </label>
                        <textarea name="ingredientes" class="form-control" rows="3" id="ingredientes"><?php echo @$ingredientes;?>
                        </textarea>
                        
                        <button type="submit" name="atualizar" class="btn btn-primary btn-lg" style="font-size: 16px; margin-top: 20px;"> Atualizar</button>
                        <?php
                            require_once "../objetos/obj_atualizar.php"; 
                        ?>
