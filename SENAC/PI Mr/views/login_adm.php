...
<body>
    ...
    <div class="container-xl" style="margin: 50px auto;">
        <div class="form_admin_logo">
            <img src="../PI Mr.Ice Cream/imagens/Logo/Logo 4 PNG.png">
        </div>
        <div class="form_admin_login">            
            <h1> ADMIN </h1>
            <?php require_once "../objetos/login_adm.php";?>
            <form method="post">
                <div class="form-group">
                    <label for="login_adm"> Email</label>
                    <input type="email" name="login_adm"class="form-control" id="login_adm" aria-describedby="emailHelp">
                </div>
                <div class="form-group">
                    <label for="senha_adm"> Senha </label>
                    <input type="password" name="senha_adm" class="form-control" id="senha_adm">
                </div>
                <button type="submit" class="btn btn-primary form_admin_botao"> Logar </button>
            </form>        
        </div>
    </div>
